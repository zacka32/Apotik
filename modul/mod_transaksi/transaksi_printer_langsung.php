			...
			<div class="box">
				...
				<div class="box-body">
				  ...
				  <table id="hrd" class="display table table-bordered table-striped" width="100%">
					...
					<?php 
						$no = 1; 
						$tampil = mysql_query("SELECT * from transaksi order by id_transaksi desc");
			...
			<div class="box">
				...
				<form action="cetak.php" method="POST">
					...
					<table width="770" border="0" cellpadding="1" cellspacing="0">
					 ...
					 <?php 
							$no = 1; 
							$tampil = mysql_query("SELECT * from detail_transaksi o left join produk p on o.c_codeprod=p.c_prodcode where id_transaksi='$_GET[id_transaksi]'");
							while($r=mysql_fetch_array($tampil)){
